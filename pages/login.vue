              ...
              <v-row>
                <v-col cols="12" md="12">
                  ...
                  <b-modal id="bv-modal-example" hide-footer>
                    <template #modal-title> Forget password </template>
                    ...
                    <b-button class="Sendpass-btn mt-3" block @click="handelforget()&&$bvModal.hide('bv-modal-example')"
                      >Send password</b-button
                    >
                  </b-modal>
                </v-col>
              </v-row>
